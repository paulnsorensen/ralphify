...
The Protocol, NamedTuple, and registry live in :mod:`_protocol` so
concrete adapter modules can depend on them without triggering a
circular import through this package's ``__init__``.
"""
